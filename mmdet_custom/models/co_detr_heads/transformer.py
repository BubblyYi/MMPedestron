...
class BaseTransformerLayer_CP(BaseTransformerLayer):
    def __init__(self,
                 attn_cfgs=None,
                 ffn_cfgs=dict(
                     type='FFN',
    ...
    def forward(self,
        ...
        **kwargs contains some specific arguments of attentions.
        ...
        ffn_index = 0
        identity = query
        print('begin:', attn_index, flush=True)
        ...
        for layer in self.operation_order:
            ...
            if layer == 'self_attn':
                ...
                def _inner_forward(query, temp_key, temp_value):
                ...
                if self.with_cp:
                    query = cp.checkpoint(
                        _inner_forward, query, temp_key, temp_value)
                else:
                    query = self.attentions[attn_index](
                        query,
                        temp_key,
...
class CoDeformableDetrTransformerDecoder(TransformerLayerSequence):
    ...
    def __init__(self, *args, return_intermediate=False,
                 look_forward_twice=False, **kwargs):
    ...
    def _init_layers(self):
        ...
        if self.with_pos_coord:
            if self.num_co_heads > 0:
                ...
                # You can fix this bug when reproducing results with swin
                # transformer.
