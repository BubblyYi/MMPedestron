...
class ViTAdapter(TIMMVisionTransformer):
    def __init__(
            ...
            deform_num_heads=6, init_values=0., interaction_indexes=None,
            with_cffn=True, cffn_ratio=0.25, deform_ratio=1.0,
            add_vit_feature=True, use_extra_extractor=True, *args, **kwargs):
            ...
            [
                InteractionBlock(
                    ...
                    extra_extractor=((True
                                      if i == len(interaction_indexes) - 1 else
    ...
    def _get_pos_embed(self, pos_embed, H, W):
        pos_embed = pos_embed.reshape(
            ...
            -1).permute(0, 3, 1, 2)
        pos_embed = F.interpolate(pos_embed, size=(H, W),
                                  mode='bicubic', align_corners=False).reshape(
            1, -1, H * W).permute(0, 2, 1)
        return pos_embed
