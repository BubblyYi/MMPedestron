...
model = dict(
    ...
    query_head=dict(
        ...
        transformer=dict(
            ...
            num_feature_levels=5,
            encoder=dict(
                type='DetrTransformerEncoder_CP',
                num_layers=6,
...
train_pipeline = [
    dict(type='LoadMultiModalitiesImages',
         mod_path_mapping_dict={
             'canwangmscoco': {
                 'img': {
                     'org_key': 'canwangmscoco/train2017',
                     'target_key': 'canwangmscoco/train2017'
                 },
                 'extra_mod_img': {
                     'org_key': 'canwangmscoco/train2017',
                     'target_key': 'canwangmscoco/train2017'
             ...
             'add_yingda_objects365': {
                 'img': {
                     'org_key': 'add_yingda_objects365/Objects365',
                     'target_key': 'add_yingda_objects365/Objects365'
                 },
                 'extra_mod_img': {
                     'org_key': 'add_yingda_objects365/Objects365',
                     'target_key': 'add_yingda_objects365/Objects365'
             ...
             'add_yingda_crowd': {
                 'img': {
                     'org_key': 'add_yingda_crowd/CrowdHuman',
                     'target_key': 'add_yingda_crowd/CrowdHuman'
                 },
                 'extra_mod_img': {
                     'org_key': 'add_yingda_crowd/CrowdHuman',
                     'target_key': 'add_yingda_crowd/CrowdHuman'
...
test_pipeline = [
    dict(type='LoadMultiModalitiesImages',
         mod_path_mapping_dict={
             'canwangmscoco': {
                 'img': {
                     'org_key': 'canwangmscoco/val2017',
                     'target_key': 'canwangmscoco/val2017'
                 },
                 'extra_mod_img': {
                     'org_key': 'canwangmscoco/val2017',
                     'target_key': 'canwangmscoco/val2017'
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Normalize', **img_norm_cfg),
            dict(type='Pad', size_divisor=32),
            # dict(type='MaskImages', masked_mod_list=['extra_mod_img']),
...
ann_prefix = 'YOUR_DTAT_ROOT_PATH/mmpedestron_datasets_ann/pretrained_ann/'
train_ann_list = [
    ann_prefix + 'coco_train2017.json',
    ann_prefix + 'objects365_train.json',
    ann_prefix + 'crowdhuman_annotation_train.json',
]

img_prefix_list = [
    'YOUR_DTAT_ROOT_PATH/mmpedestron_images/COCO/train2017',
    'YOUR_DTAT_ROOT_PATH/mmpedestron_images//Objects365',
    'YOUR_DTAT_ROOT_PATH/mmpedestron_images/CrowdHuman',
]


val_list = [
    'YOUR_DTAT_ROOT_PATH/mmpedestron_datasets_ann/pretrained_ann/instances_val2017.json',
    'YOUR_DTAT_ROOT_PATH/mmpedestron_datasets_ann/pretrained_ann/crowdhuman_annotation_val.json',
]

val_img_prefix_list = [
    'YOUR_DTAT_ROOT_PATH/mmpedestron_images/COCO/val2017',
    'YOUR_DTAT_ROOT_PATH/mmpedestron_images/CrowdHuman/',
]
