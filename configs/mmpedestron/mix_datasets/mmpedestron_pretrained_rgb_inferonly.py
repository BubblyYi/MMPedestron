...
ann_prefix3 = 'YOUR_DTAT_ROOT_PATH/mmpedestron_datasets_ann/evs_dataset/evs_human_1013/'
ann_prefix4 = 'YOUR_DTAT_ROOT_PATH/mmpedestron_datasets_ann/STCrowd_Raw/coco_ann/'
ann_prefix5 = 'YOUR_DTAT_ROOT_PATH/mmpedestron_datasets_ann/crowdhuman_coco/'

train_ann_list = [
    ann_prefix + 'LLVIP_coco_train_change_cat_id.json',
    ann_prefix2 + 'InOutDoorPeopleRGBD_train_set_correct.json',
    ann_prefix3 + 'train.json',
    ann_prefix4 + 'train_set_lidar_mask.json',
    ann_prefix5 + 'annotation_train_full2coco_231020.json',  # 11
