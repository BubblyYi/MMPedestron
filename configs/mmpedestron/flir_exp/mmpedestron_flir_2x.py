...
train_pipeline = [
    dict(type='LoadMultiModalitiesImages',
         mod_path_mapping_dict={
             'FLIR_aligned': {
                 'img': {
                     'org_key': '_PreviewData.jpeg',
                     'target_key': '_PreviewData.jpeg'
                 },
                 'extra_mod_img': {
                     'org_key': '_PreviewData.jpeg',
                     'target_key': '_RGB.jpg'
...
ann_prefix = 'YOUR_DTAT_ROOT_PATH/mmpedestron_datasets_ann/FLIR_aligned/'

train_ann_list = [
    ann_prefix + 'flir_aligned_train.json',

]
img_prefix_list = [
    'YOUR_DTAT_ROOT_PATH/mmpedestron_datasets_ann/FLIR_aligned/JPEGImages/',
]

val_list = [
    ann_prefix + 'flir_aligned_val.json',
]
...
dataset_type = 'CocoPedestronDataset_FLIR'
data = dict(
    samples_per_gpu=1,
    workers_per_gpu=2,
    train=dict(
